...
return [
    ...
    'missing_unless' => '除非 :other 在 :values 中，否则 :attribute 必须缺失。',
    ...
    'password' => [
        ...
        'uncompromised' => '该 :attribute 曾在数据泄露中出现，请选择其他 :attribute。',
    ],
    ...
    'prohibited_if' => '当 :other 为 :value 时，:attribute 禁止填写。',
    'prohibited_if_accepted' => '当 :other 被接受时，:attribute 禁止填写。',
    'prohibited_if_declined' => '当 :other 被拒绝时，:attribute 禁止填写。',
    'prohibited_unless' => '除非 :other 在 :values 中，否则 :attribute 禁止填写。',
